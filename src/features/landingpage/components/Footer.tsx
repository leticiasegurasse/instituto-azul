        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed">
              Especialistas em ABA aplicada à Fonoaudiologia, oferecendo cursos 
              e treinamentos para profissionais que trabalham com TEA.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li><span className="text-[var(--azul-claro)]">30 horas de conteúdo</span></li>
              <li><span className="text-[var(--azul-claro)]">Certificação inclusa</span></li>
              <li><span className="text-[var(--azul-claro)]">Material de apoio</span></li>
              <li><span className="text-[var(--azul-claro)]">Acesso às gravações</span></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-[var(--azul-claro)] transition-colors">Dúvidas Frequentes</a></li>
              <li><a href="#" className="hover:text-[var(--azul-claro)] transition-colors">Contato</a></li>
              <li><a href="#" className="hover:text-[var(--azul-claro)] transition-colors">WhatsApp</a></li>
              <li><a href="#" className="hover:text-[var(--azul-claro)] transition-colors">E-mail</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-[var(--azul-medio)] pt-8 mb-8">
          <div className="max-w-2xl mx-auto text-center space-y-4">
            ...
            <p className="text-[var(--azul-claro)]">
              Conteúdos exclusivos sobre ABA e fonoaudiologia direto no seu e-mail
            </p>
